...
<div class="wrapper">
    ...
    <@netCommon.commonLeft "send-success" />
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-2">
                    <div class="input-group">
                        <input type="text" class="form-control" id="messageId" autocomplete="on" value="${messageId!}" placeholder="消息ID"/>
                    </div>
                </div>
                <div class="col-xs-2">
                    <div class="input-group">
                ...
                <div class="col-xs-3">
                    <div class="input-group">
                        ...
                        <input type="hidden" id="consumeTime" value="${consumeTime?c!}">
                    </div>
                </div>
                <div class="col-xs-1">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-body">
                            <table id="send-success-list" class="table table-bordered table-striped" width="100%">
                                <thead>
                                <tr>
...
<script src="${request.contextPath}/static/js/send-success.js"></script>
</body>
</html>
