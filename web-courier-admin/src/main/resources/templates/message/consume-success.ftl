...
<div class="wrapper">
    ...
    <@netCommon.commonLeft "consume-success" />
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-xs-2">
                    <div class="input-group">
                        <input type="text" class="form-control" id="messageId" value="${messageId!}" autocomplete="on" placeholder="消息ID"/>
                    </div>
                </div>
                <div class="col-xs-2">
                    <div class="input-group">
                ...
                <div class="col-xs-3">
                    <div class="input-group">
                        ...
                        <input type="hidden" id="createAt" value="${createAt?c!}">
                    </div>
                </div>
                <div class="col-xs-1">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-body">
                            <table id="consume-success-list" class="table table-bordered table-striped display" width="100%">
                                <thead>
                                <tr>
                                    <th name="consumeId">消费ID</th>
                                    <th name="messageId">消息ID</th>
                                    <th name="fromService">发送服务</th>
                                    <th name="toService">消费服务</th>
                                    <th name="topic">Topic</th>
                                    <th name="groupId">消费组</th>
                                    <th name="state">状态</th>
                                    <th name="consumeTime">消费时间</th>
...
<script src="${request.contextPath}/static/js/consume-success.js"></script>
</body>
</html>
